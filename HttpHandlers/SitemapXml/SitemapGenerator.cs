    ...
    public static class SitemapGenerator
    {
        ...
        public static XmlDocument Generate(HttpRequest request, bool useCachedCopyIfAvailable)
        {
            ...
            if (doc == null || !useCachedCopyIfAvailable)
            {
                ...
                HttpRuntime.Cache.Insert(key, doc, null, DateTime.Now.AddMinutes(cachetime), Cache.NoSlidingExpiration);
            }
        ...
        /// </returns>
        public static ISitemapNode CreateNode(IPublishedContent item, UmbracoContext site)
        {
            var nodeType = Type.GetType(SitemapXmlHandlerConfiguration.Settings.SitemapNodeType);
